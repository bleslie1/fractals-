...
fractalNetModule3D=DynamicModule[{alphatheta=0},Column[{Panel[Grid[{{"n",SetterBar[Dynamic[n],{0,1,2,3}]},{"net",Checkbox[Dynamic[net]]},{"Fold",Slider[Dynamic[alphatheta],{0,foldedAngle}]}},Alignment->Left,ItemSize->{{10,40}}],ImageSize-> {600,125},Background->White],
